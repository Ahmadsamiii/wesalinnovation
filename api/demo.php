...
function seedDemoContent(int $demoUserId): void {
    ...
    // تذاكر الدعم للمستفيد التجريبي — بحالات النظام الحالي (TICKET_STATUSES)؛ open/done القديمتان
    // يرفضهما عمود الحالة بعد ترقيته في migrateTickets() فيفشل الإنشاء كله
    ...
    foreach ([
        ['بلاغ عن معلومة غير دقيقة',
         'الإجابة عن إعانة التأهيل الشامل ذكرت مبلغاً يبدو قديماً. أرجو التحقق من صفحة الخدمة الرسمية.', 'new', 5],
        ['تعديل رقم الجوال',
         'غيّرت رقمي وأبغى أحدّثه في حسابي. الرقم الجديد ينتهي بـ 0412.', 'new', 26],
        ['مشكلة تقنية في المنصة',
         'القراءة الصوتية ما تشتغل عندي على المتصفح، تبدأ وتتوقف بعد جملة.', 'closed', 72],
